...
export function MaritimeForm(props: MaritimeFormProps) {
  const { formData, updateField } = useFormData();
  
  // Mock templates - in real app, these would come from the backend
  const templates = [
    'Proforma_Invoice malaba cement 0.5.xlsx',
    'Proforma_Invoice malaba.xlsx',
    'PROFORMA_Maritime malaba 1X20.xlsx',
    'PROFORMA_Maritime malaba 1X40.xlsx'
  ];

  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-2">Upload Maritime PDF</h2>
        <p className="text-gray-600">Process maritime FERI documents with container specifications</p>
      </div>
