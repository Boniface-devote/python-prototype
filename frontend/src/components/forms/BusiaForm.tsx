...
export function BusiaForm(props: BusiaFormProps) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-2">Upload Busia PDF</h2>
        <p className="text-gray-600">Process Busia FERI documents with container specifications</p>
      </div>
